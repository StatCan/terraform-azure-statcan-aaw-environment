module "network" {
  source = "git::https://gitlab.k8s.cloud.statcan.ca/cloudnative/aaw/modules/terraform-azure-statcan-aaw-network.git?ref=v1.3.10"
  ...
  ingress_geoanalytics_private_ip             = var.ingress_geoanalytics_private_ip
  ingress_jfrog_private_ip                    = var.ingress_jfrog_private_ip
